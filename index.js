...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function addToChat(input, finalResult) {
    ...
    userDiv.innerHTML = `<span>${input}</span><img src="https://img.icons8.com/doodle/344/user-male-circle.png" alt="Robot cartoon" height="20px" width="20px">`;
    ...
    botDiv.id = "bot";
    botImg.src = "https://imgs.search.brave.com/qTwHTuL__vECPdOp69olToU-MFTsObiVMN4cgOP5Itk/rs:fit:1200:1200:1/g:ce/aHR0cDovL2Rlc2ln/bmxvb3Rlci5jb20v/aW1hZ2VzL3JvYm90/LXN2Zy0xMi5wbmc";
    botImg.className = "avatar";
    botDiv.className = "bot response";
    botText.innerText = "yekteb..";
